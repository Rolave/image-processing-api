...
var cacheMiddleware = function (duration) {
    ...
    return function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, image, width, height, format, key, cachedResponse, imageWidth, imageHeight, imageResponse;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = req.query, image = _a.image, width = _a.width, height = _a.height, format = _a.format;
                    key = getkeyName(image, width, height, format);
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, _1.createImgThumb)(image, imageWidth, imageHeight, format)];
                case 2:
...
//# sourceMappingURL=cacheUtilities.js.map